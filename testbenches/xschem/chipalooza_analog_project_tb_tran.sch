...
only_toplevel=true 
value="
.include ../../../netlist/pex/chipalooza_analog_project_magic_pex_3.spice
.param VPWR=1.5
.csparam VPWR=VPWR
.param VAPWR=1.5
.csparam VAPWR=VAPWR
...
C {chipalooza_analog_project.sym} 2720 -1080 0 0 {name=x2
spice_ignore=true}
C {chipalooza_analog_project_pex.sym} 2720 -360 0 0 {name=x3
spice_ignore=true}
C {chipalooza_analog_project.sym} 1080 -800 0 0 {name=x1
}
