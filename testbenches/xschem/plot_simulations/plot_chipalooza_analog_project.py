...
def main():
    ...
    # ------------------------------------------------------------------
    ngspice_file = data_dir / "chipalooza_analog_project_tb_tran.txt"
    ...
    # ------------------------------------------------------------------
    fig1.savefig(str(figures_dir / "chipalooza_analog_project_tb_tran.svg"), bbox_inches='tight')
    fig1.savefig(str(figures_dir / "chipalooza_analog_project_tb_tran.pdf"), bbox_inches='tight')
    np.savetxt(str(figures_dir / "chipalooza_analog_project_tb_tran.csv"),
