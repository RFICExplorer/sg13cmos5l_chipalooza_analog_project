...
value="
.temp 27
.options savecurrents sparse reltol=1e-5 abstol=1e-15 gmin=1e-15

.control
save all
noise v(PKG_OUT) VNOISE_IN dec 200 100Meg 10G

setplot noise1
let source_noise_density=sqrt(4*1.380649e-23*300.15*50)
let noise_factor=(inoise_spectrum/source_noise_density)^2
let NF_dB=10*log10(noise_factor)

echo ===== PACKAGE_LNA_NOISE_FIGURE =====

set wr_singlescale
set wr_vecnames
wrdata ../plot_simulations/data/lna_noise_package.dat frequency NF_dB inoise_spectrum onoise_spectrum
