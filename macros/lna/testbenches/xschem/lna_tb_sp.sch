...
C {lab_pin.sym} 590 -1050 2 0 {name=p17 sig_type=std_logic lab=PORT1_EXT}
...
C {lab_pin.sym} 550 -980 1 0 {name=p12 sig_type=std_logic lab=PORT1_EXT}
...
C {lab_pin.sym} 1250 -830 1 0 {name=p20 sig_type=std_logic lab=PORT2}
...
C {lab_pin.sym} 1280 -1050 0 0 {name=p22 sig_type=std_logic lab=PORT2}
...
set wr_singlescale
set wr_vecnames
wrdata ../plot_simulations/data/lna_sp_fully_matched.dat frequency vdb(s_1_1) vdb(s_2_1) vdb(s_1_2) vdb(s_2_2) K
